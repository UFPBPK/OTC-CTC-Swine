...
## Study 5 : Gingdher et al., 1990;PO;K,L,F; Dose: 300 mg/kg/day; Repeat: 7
...
### Study 6 :Gingdher et al., 1990; PO; K,L,F;Dose: 400 mg/kg/day; Repeat: 7; 
...
### Study 7 :Berger et al.,1983; PO; K;Dose: 440 mg/kg/day; Repeat: 14
...
Cost_Swine <- function (pars, w) {
  ...
  out_A7_PO  <- pred (fixpars = FixPars_Swine, Vpars = pars, BW =40, Dose =220, Dtimes = 28, tinterval =12, route = "oral")
...
Cost_Swine_eva <- function (pars, w) {
  ...
  out_A5_PO  <- pred (fixpars = FixPars_Swine, Vpars = pars, BW =40, Dose =150, Dtimes = 14, tinterval =12, route = "oral")
  out_A6_PO  <- pred (fixpars = FixPars_Swine, Vpars = pars, BW =40, Dose = 200, Dtimes = 14, tinterval =12, route = "oral")
...
Out_Cal     <- rbind.data.frame(
  ...
  out_A5_1    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 150, Dtimes = 14,tinterval = 12,route = "oral",endtime=432)%>%
    select(Time = Time, Conc = CK)%>%mutate(Study = 'A5_1'), 
  out_A5_2    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 150, Dtimes = 14,tinterval = 12, route = "oral",endtime=432)%>%
    select(Time = Time, Conc = CF)%>%mutate(Study = 'A5_2'), 
  out_A5_3    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 150, Dtimes =14,tinterval = 12,route = "oral",endtime=432)%>%
    select(Time = Time, Conc = CL)%>%mutate(Study = 'A5_3'), 
  out_A6_1    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 200, Dtimes = 14,tinterval = 12, route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CK)%>%mutate(Study = 'A6_1'), 
  out_A6_2    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 200, Dtimes = 14,tinterval = 12,route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CF)%>%mutate(Study = 'A6_2'), 
  out_A6_3    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 200, Dtimes = 14,tinterval = 12,route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CL)%>%mutate(Study = 'A6_3'), 
  out_A7_1    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 220, Dtimes = 28,tinterval = 12, route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CK)%>%mutate(Study = 'A7_1'),
  out_A7_2    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 220, Dtimes = 28,tinterval = 12, route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CF)%>%mutate(Study = 'A7_2'),
  out_A7_3    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 220, Dtimes = 28,tinterval = 12, route = "oral",endtime=510)%>%
    select(Time = Time, Conc = CL)%>%mutate(Study = 'A7_3'),
  out_A7_4    <- preda (Vpars = Pars_CTC, BW = 40, Dose = 220, Dtimes = 28, tinterval = 12,route = "oral",endtime=510)%>%
